...
class ChatViewController: MessagesViewController {
    ...
    override func viewDidLoad() {
        ...
        let callButton = UIBarButtonItem(image: UIImage(systemName: "phone"), style: .plain, target: self, action: #selector(loadCallView))
        let infoButton = UIBarButtonItem(image: UIImage(systemName: "info.circle"), style: .plain, target: self, action: #selector(loadInfoView))
        navigationItem.rightBarButtonItems = [infoButton, callButton]
    ...
    @objc private func loadCallView() {
        let vc = CallViewController()
        vc.hidesBottomBarWhenPushed =  true
        navigationController?.pushViewController(vc, animated: true)
    }
    
    @objc private func loadInfoView() {
           ...
           let imageData = image.pngData() {
            ...
            StorageManager.shared.uploadMessagePhoto(with: imageData, fileName: fileName, completion: { [weak self] result in
                ...
                case .success(let urlString):
                    ...
                    print("Uploaded mesage photo: \(urlString)")
            ...
            StorageManager.shared.uploadMessageVideo(with: videoUrl, fileName: fileName, completion: { [weak self] result in
                ...
                case .success(let urlString):
                    // ready to send message
                    print("Uploaded mesage video: \(urlString)")
